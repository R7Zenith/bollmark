...
- ➖ Ürün başlığı Bollmark'ta normal harf büyüklüğünde (`text-sm text-ink`, tümü büyük harf değil) — bu bilinçli bir tasarım tercihi olabilir, Release'in tamamı büyük harf başlık stiliyle birebir aynı olması gerekmiyorsa dokunmaya gerek yok.
...
Release Shopify temasının canlı demosunu (themes.shopify.com/themes/release/presets/release, "Jackets & Coats" kategorisi ve arama sonuçlarında "sale" araması) referans alarak katalog/ürün kartlarımızı (`src/components/product-card.tsx`, `src/lib/catalog.ts`, `src/app/(site)/urunler/page.tsx`) şu 3 noktada güncelle:
...
Ürün başlıklarının büyük/küçük harf stiline veya grid boşluklarına dokunma — onlar zaten Release ile uyumlu ve bilinçli bir tercih. Değişiklikleri yapmadan önce hangi ürünlerde/renklerde ikinci fotoğraf zaten kayıtlı olduğunu kontrol et, test için o ürünleri kullan.

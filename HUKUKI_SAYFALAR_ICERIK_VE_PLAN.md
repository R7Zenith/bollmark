# Bollmark – Hukuki Sayfalar: İçerik ve Uygulama Planı

> Bu dosya iyzico başvurusu için gerekli 4 sayfanın (Gizlilik Politikası+KVKK, Mesafeli Satış Sözleşmesi, Teslimat-İade Şartları, Hakkımızda) hazır metinlerini içerir. Claude Code bu dosyayı okuyup projeye sayfa olarak ekleyecek.

## Kullanılan işletme bilgileri (teyit edilmiş)

- Ad Soyad / Unvan: **Oğuzhan Leventoğlu**
- İşletme adı: **Bollmark**
- Vergi Dairesi: Karacabey
- Vergi No: 6080753452
- Esnaf/Ticaret Sicil No: 4651
- Adres: Runguçpaşa Mah. 75. Sk. No:6/A Karacabey/Bursa
- E-posta: bilgi@bollmark.com
- Telefon: **belirtilmedi — aşağıda önemli not var**
- Ödeme yöntemi: yalnızca iyzico
- Kargo firması: **henüz seçilmedi**
- Teslimat süresi: 1-3 iş günü
- İade kargo ücreti: alıcı öder
- İade adresi: iş yeri adresiyle aynı
- İade edilemeyecek ürünler: iç giyim / mayo gibi hijyen ürünleri (ambalajı açılmışsa)
- Cayma/iade süresi: yasal asgari 14 gün
- Satılan ürün grupları: kadın, erkek, çocuk ayakkabı; valiz; aksesuar; çeşitli marka ürünler
- Marka geçmişi: 40 yılı aşkın ticaret hayatı, 2016'dan beri Koton Corner Mağazası

### ⚠️ Kod yazmadan önce çözülmesi gereken 2 nokta

1. **Telefon numarası yok.** iyzico başvuru sayfası, ana sayfada kolay erişilebilir bir "İletişim" bölümünde iş yeri adı, vergi no, adres, **telefon**, e-posta bilgisi istiyor. Başvurudan önce en az bir telefon numarası eklenmeli (sabit hat, GSM ya da WhatsApp hattı olabilir).
2. **Kargo firması henüz belirlenmedi.** Teslimat-İade sayfası aşağıda "anlaşmalı kargo firmalarımız" gibi genel bir ifadeyle yazıldı. Firma netleşince (Yurtiçi/Aras/MNG vb.) tek satır güncellenmesi yeterli.

---

## 1) Gizlilik Politikası ve KVKK Aydınlatma Metni

*(Route önerisi: `/gizlilik-politikasi`)*

```markdown
# Gizlilik Politikası ve Kişisel Verilerin Korunması Aydınlatma Metni

Bu Gizlilik Politikası ve Aydınlatma Metni, bollmark.com ("Site") üzerinden gerçekleştirdiğiniz alışverişler ve site kullanımınız sırasında elde edilen kişisel verilerinizin, 6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") kapsamında nasıl işlendiğini açıklamak amacıyla hazırlanmıştır.
...
## 2) Mesafeli Satış Sözleşmesi ve Ön Bilgilendirme Formu

*(Route önerisi: `/mesafeli-satis-sozlesmesi`. Sipariş adımında ayrıca onay kutusu ile kabul ettirilmeli.)*
...
*(Route önerisi: `/teslimat-ve-iade`)*
...
- Siparişleriniz, ödemenin onaylanmasının ardından **1-3 iş günü** içinde hazırlanıp kargoya teslim edilir.
...
Mesafeli Satış Sözleşmesi'nde belirtildiği üzere, teslim aldığınız üründen **14 gün içinde**, hiçbir gerekçe göstermeksizin cayma hakkınızı kullanabilirsiniz.
...
*(Route önerisi: `/hakkimizda`)*

```markdown
# Hakkımızda

Bollmark, 40 yılı aşkın bir ticaret geçmişine sahip bir aile işletmesidir. 2016 yılından bu yana Koton'un Corner Mağazası olarak hizmet vermekte, aynı zamanda kadın, erkek ve çocuk ayakkabı, valiz ve aksesuar kategorilerinde çeşitli markalara ait ürünleri müşterilerimizle buluşturmaktayız.
...
## Claude Code için uygulama notları

- Yukarıdaki 4 içerik hazır; kodlama Claude Code tarafında yapılacak.
- Next.js App Router yapısına uygun 4 statik sayfa (route'lar öneri niteliğinde, proje kuralına göre ayarlanabilir) ve footer'a bu sayfalara linkler eklenmeli.
- Mesafeli Satış Sözleşmesi, checkout/ödeme adımında bir onay kutusu ("Mesafeli Satış Sözleşmesi'ni okudum, onaylıyorum") ile kabul ettirilmeli ve bu onay sipariş kaydına işlenmeli (KVKK/ispat yükü açısından önemli).
- "[YAYIN TARİHİ]" placeholder'ları, sayfalar canlıya alınırken gerçek tarihle değiştirilmeli.
- Telefon numarası netleşince Gizlilik Politikası ve Mesafeli Satış Sözleşmesi'ndeki iletişim bilgilerine eklenmeli; ayrıca site genelinde (footer/iletişim) görünür olmalı — iyzico başvurusu bunu bekliyor.
- Kargo firması netleşince Teslimat ve İade sayfasındaki "anlaşmalı kargo firmamız" ifadesi firma adıyla güncellenebilir (zorunlu değil, güven artırıcı).

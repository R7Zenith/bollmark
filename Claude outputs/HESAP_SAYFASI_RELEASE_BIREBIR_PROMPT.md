...
- Mobilde (`lg:hidden`) bu sidebar'ın nasıl davranacağına dikkat et — Release masaüstünde sidebar solda sabit; dar ekranda muhtemelen sidebar üstte tam genişlik liste olarak kalabilir (basit çözüm: `lg:w-[320px] w-full` zaten layout'ta var, ekstra responsive collapse gerekmiyor).
